          ...
          <Col xs="12" sm="6" lg="6">
            <Card className="text-white bg-warning">
              ...
              <CardBody>
                {/*<Row>*/}
                  {/*<Col sm="5">*/}
                    {/*<CardTitle className="mb-0">Financial Reports</CardTitle>*/}
                    {/*<div className="small text-muted">October 2018</div>*/}
                  {/*</Col>*/}
                  ...
                  {/*</Col>*/}
                {/*</Row>*/}
                <div className="chart-wrapper" style={{ height: 270 + 'px', marginTop: 40 + 'px' }}>
          ...
          <Col xs="12" sm="6" lg="6">
            <Card className="text-white bg-danger">
              ...
              <CardBody className="pb-0">
                ...
                <div className="text-value">12 Events</div>
                <div>Deadline in less than a week</div>
                <br/>
              </CardBody>
            </Card>
          </Col>
          ...
          <Col xs="12" sm="6" lg="6">
            <Card className="text-white bg-primary">
              ...
              <CardBody className="pb-0">
                ...
                <div className="text-value">23 Offers</div>
